...
class FixWallGran : public Fix {
 public:
  ...
  void hertz_history(double, double, double, double, double *, double,
                     double *, double *, double *, double *, double, double,
                     double *); 
      //void hertzpolynomial_history(double, double, double, double, double *, double,
      //             double *, double *, double *, double *, double, double,
      //             double *, char * , FILE **, int);//HC
  void hertzpolynomial_history(double, double, double, double, double *, double,
                     double *, double *, double *, double *, double, double,
                     double *, double *);//HC
  void bonded_history(double, double, double, double, double *, double,
      ...
      /****************************************************/
      virtual void pack_data_wallgran(double **);
      virtual void write_data_wallgran(FILE *, int, double **);
      /****************************************************/
