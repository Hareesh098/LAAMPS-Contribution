...
CommandStyle(write_fixwallgran,WriteFixWallGran)

#else

#ifndef LMP_WRITE_WALLGRAN_H
#define LMP_WRITE_WALLGRAN_H
...
class WriteFixWallGran : protected Pointers {
 public:
  WriteFixWallGran(class LAMMPS *);
