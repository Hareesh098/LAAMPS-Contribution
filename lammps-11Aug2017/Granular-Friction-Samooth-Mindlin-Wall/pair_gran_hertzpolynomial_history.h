...
PairStyle(gran/hertzpolynomial/history,PairGranHertzPolynomialHistory)

#else

#ifndef LMP_PAIR_GRAN_HERTZPOLYNOMIAL_HISTORY_H
#define LMP_PAIR_GRAN_HERTZPOLYNOMIAL_HISTORY_H

#include "pair.h"

namespace LAMMPS_NS {

class PairGranHertzPolynomialHistory : public Pair {
 public:
  PairGranHertzPolynomialHistory(class LAMMPS *);
  virtual ~PairGranHertzPolynomialHistory();
